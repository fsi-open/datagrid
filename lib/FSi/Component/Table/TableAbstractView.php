...
class TableAbstractView implements TableViewInterface
{
    ...
    public function current()
    {
        ...
        return new TableRowView($this->columns, $this->rowset[$this->position], $index);
    }
    ...
    public function offsetGet($offset)
    {
        if ($this->offsetExists($offset)) {
            return new TableRowView($this->columns, $this->rowset[$offset]);
        }
