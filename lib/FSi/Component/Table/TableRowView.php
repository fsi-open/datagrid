...
class TableRowView implements TableRowViewInterface
{
    ...
    {    
        ...
        foreach ($this->columns as $name => $column) {
            if (!($column instanceof ColumnTypeInterface)) {
                throw new UnexpectedTypeException($column, 'FSi\Component\Table\Column\ColumnTypeInterface');
            }
     ...
     *
     * @return TableColumnView current element from the rowset
     */
